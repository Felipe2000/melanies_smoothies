...
if ingredients_list:
    ...
    for fruit_chosen in ingredients_list:
        ...
        smoothiefruit_response = requests.get("https://www.smoothiefroot.com/api/fruit/"+fruit_chosen)
        st_df=st.dataframe(smoothiefruit_response.json(), use_container_width=True)
